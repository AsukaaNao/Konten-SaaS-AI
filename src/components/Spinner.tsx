...
import { Card, CardContent, Button, Modal, ModalHeader, ModalTitle, ModalBody, ModalFooter, CardHeader, CardTitle, CardFooter } from '../constants';
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <p className="text-sm font-semibold">{appUser.displayName}</p>
                                <p className="text-sm mt-2">{project.caption}</p>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="date" id="date" value={date} onChange={e => setDate(e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#5890AD] focus:ring-[#5890AD] sm:text-sm p-2 bg-white" />
                                </div>
                                <div>
                                    <label htmlFor="time" className="block text-sm font-medium text-gray-700">Waktu</label>
                                    <input type="time" id="time" value={time} onChange={e => setTime(e.target.value)} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#5890AD] focus:ring-[#5890AD] sm:text-sm p-2 bg-white" />
                                </div>
                            </CardContent>
                            <CardFooter>
            ...
            <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
                <ModalHeader>
                    <ModalTitle>Connect Your Instagram Account</ModalTitle>
                </ModalHeader>
                <ModalBody>
                    <p className="text-sm text-gray-600">To schedule posts, you need to connect your Instagram account first. This only takes a moment.</p>
                </ModalBody>
                <ModalFooter>
...
export const SettingsPage: React.FC<SettingsPageProps> = ({ user, onLogout, onNavigate, onToggleConnection }) => {
    return (
        <div className="min-h-screen bg-gray-50">
            <Header user={user} onLogout={onLogout} onBack={() => onNavigate('dashboard')} onNavigate={onNavigate} />
                        ...
                        <CardContent>
                           <div className="flex items-center justify-between">
                               <div>
                                   ...
                                   <p className={`text-sm ${user.isInstagramConnected ? 'text-green-600' : 'text-gray-500'}`}>
